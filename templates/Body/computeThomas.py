...
def compute(settings):
    ...
    pvBall = ["Pivot_Ball_L"]
    MatrixConstrain.MatrixConstrain(pvBall, "IK_Leg_L", sX = False , sY = False, sZ = False)
    # Connect the DrvJnt_Ankle_L to the Bind_Foot_L
    drvAnkle = ["DrvJnt_Ankle_L"]
    MatrixConstrain.MatrixConstrain(drvAnkle, "Bind_Foot_L", sX = False , sY = False, sZ = False)
