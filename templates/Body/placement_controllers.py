...
def transformRelative(controller, position = [0,0,0], rotation = [0,0,0], scale = [1, 1, 1]):
    cmds.setAttr(controller + ".translate", position[0], position[1], position[2])
    cmds.setAttr(controller + ".rotate", rotation[0], rotation[1], rotation[2])
    cmds.setAttr(controller + ".scale", scale[0], scale[1], scale[2])
...
def placeGlobalControllers(settings) :
    ...
    transformRelative("PlacementCtrl_Global", [0, 1, 0], [0, 0, 0], [65, 65, 65])
    ...
    transformRelative("PlacementCtrl_Root", [0, 87, -1.7], [0, 0, 0], [20, 20, 16])
    ...
    transformRelative("PlacementCtrl_Settings", [0, 1, -68], [0, 0, 0], [17, 17, 17])
    ...
    transformRelative("PlacementCtrl_Settings_Head", [0, 1, -57], [0, 0, 0], [2.6, 2.6, 2.6])
    ...
    transformRelative("PlacementCtrl_Settings_Leg_L", [4.19, 1, -77], [0, -15, 0], [1.5, 3.9, 5.0])
    ...
    transformRelative("PlacementCtrl_Settings_Leg_R", [-4.19, 1, -77], [0, 15, 0], [1.5, 3.9, 5.0])
    ...
    transformRelative("PlacementCtrl_Settings_Arm_L", [6.5, 1, -65], [0, -50, 0], [1.6, 5, 5])
    ...
    transformRelative("PlacementCtrl_Settings_Arm_R", [-6.5, 1, -65], [0, 50, 0], [1.6, 5, 5])
    ...
    transformRelative("PlacementCtrl_Settings_Spine", [0, 1, -67], [0, 0, 0], [2.7, 6.4, 5.3])
...
def placeSpineControllers(settings) :
    ...
    transformRelative("PlacementCtrl_Hip", [0, 101, -2.0], [180, 90, 0], [14.6, 8, 8.2])
    ...
    transformRelative("PlacementCtrl_Shoulder", [0, 118, 0.5], [-4, 0, 0], [2.5, 1.2, 2.5])
    ...
    transformRelative("PlacementCtrl_Neck_01", [0, 140, -3.4], [0, 0, 0], [7.7, 7.7, 7.7])
    ...
    transformRelative("PlacementCtrl_Spine_01", [0, 107, 2], [0, 0, 0], [14.7, 14.7, 12.7])
...
def placeLegsControllers(settings) :
    ...
    transformRelative("PlacementCtrl_Fk_Leg_R", [-9.621,82.611, -1.5], [0, 0, 0], [10, 10, 10])
    ...
    transformRelative("PlacementCtrl_Fk_Knee_R", [-8.677, 49, -1.5], [0, 0, 0], [7.2, 7.2, 7.2])
    ...
    transformRelative("PlacementCtrl_Fk_Ankle_R", [-7.324, 12.9, 0], [0, 0, 0], [7, 7, 7])
    ...
    transformRelative("PlacementCtrl_Fk_Ball_R", [-7.7, 3, 7.7], [-65.46, 0, 0], [7, 7, 7])
    ...
    transformRelative("PlacementCtrl_Foot_R", [-7.9, 0, 6.497], [0, 0, 0], [8.6, 7, 6.8])
    ...
    transformRelative("PlacementCtrl_Pv_Leg_R", [-9, 50, 38], [-90, 0, 0], [1, 1, 1])
    ...
    transformRelative("PlacementCtrl_Ribbon_Leg_R", [-9.621, 67, -0.8], [0, 0, 0], [8.4, 8.4, 8.4])
    ...
    transformRelative("PlacementCtrl_Ribbon_Knee_R", [-8.677, 30, -4], [0, 0, 0], [6.4, 6.4, 6.4])
    ...
    transformRelative("PlacementCtrl_Pin_Knee_R", [-8.677, 49, -1.5], [0, 0, 0], [5.4, 5.4, 5.4])
    ...
    transformRelative("PlacementCtrl_Fk_Leg_L", [9.621, 82.611, -1.5], [0, 0, 0], [10, 10, 10])
    ...
    transformRelative("PlacementCtrl_Fk_Knee_L", [8.677, 49, -1.5], [0, 0, 0], [7.2, 7.2, 7.2])
    ...
    transformRelative("PlacementCtrl_Fk_Ankle_L", [7.324, 12.9, 0], [0, 0, 0], [7, 7, 7])
    ...
    transformRelative("PlacementCtrl_Fk_Ball_L", [7.7, 3, 7.7], [-65.46, 0, 0], [7, 7, 7])
    ...
    transformRelative("PlacementCtrl_Foot_L", [7.9, 0, 6.497], [0, 0, 0], [8.6, 7, 6.8])
    ...
    transformRelative("PlacementCtrl_Pv_Leg_L", [9, 50, 38], [-90, 0, 0], [1, 1, 1])
    ...
    transformRelative("PlacementCtrl_Ribbon_Leg_L", [9.621, 67, -0.8], [0, 0, 0], [8.4, 8.4, 8.4])
    ...
    transformRelative("PlacementCtrl_Ribbon_Knee_L", [8.677, 30, -4], [0, 0, 0], [6.4, 6.4, 6.4])
    ...
    transformRelative("PlacementCtrl_Pin_Knee_L", [8.677, 49, -1.5], [0, 0, 0], [5.4, 5.4, 5.4])
...
def placeArmsControllers(settings):
    ...
    transformRelative("PlacementCtrl_Clavicle_R", [-12, 132, -5.4], [0, 0, 15], [5, 5, 4.5])
    ...
    transformRelative("PlacementCtrl_Fk_Shoulder_R", [-16.5, 130, -5.2], [0, 0, -58.2], [6.5, 6.5, 6.5])
    ...
    transformRelative("PlacementCtrl_Fk_Elbow_R", [-30,116,-8.4], [0, 0, -51], [6, 6, 6])
    ...
    transformRelative("PlacementCtrl_Fk_Wrist_R", [-49,98,-4], [-12.4, 0.7,-47], [-3.7, 3.7, 3.7])
    ...
    transformRelative("PlacementCtrl_Ik_Arm_R", [-49,98,-4], [-12.4, 0.7,-47], [-3.7, 3.7, 3.7])
    ...
    transformRelative("PlacementCtrl_Pv_Arm_R", [-29, 116, -34], [-90, 180, 0], [1, 1, 1])
    ...
    transformRelative("PlacementCtrl_Ribbon_Arm_R", [-22, 123,-6.5], [7.1,0,-51], [6, 6, 6])
    ...
    transformRelative("PlacementCtrl_Ribbon_Elbow_R", [-40, 106 , -6.5], [-6, 0 , -51], [5, 5, 5])
    ...
    transformRelative("PlacementCtrl_Pin_Elbow_R", [-30,116,-8.4], [0, 0, -51], [5.2, 5.2, 5.2])
    ...
    transformRelative("PlacementCtrl_Clavicle_L", [12, 132, -5.4], [0, 0, -15], [5, 5, 4.5])
    ...
    transformRelative("PlacementCtrl_Fk_Shoulder_L", [16.5, 130, -5.2], [0, 0, 58.2], [6.5, 6.5, 6.5])
    ...
    transformRelative("PlacementCtrl_Fk_Elbow_L", [30, 116, -8.4], [0, 0, 51], [6, 6, 6])
    ...
    transformRelative("PlacementCtrl_Fk_Wrist_L", [49, 98, -4], [12.4, -0.7, 47], [3.7, 3.7, 3.7])
    ...
    transformRelative("PlacementCtrl_Ik_Arm_L", [49, 98, -4], [12.4, -0.7, 47], [3.7, 3.7, 3.7])
    ...
    transformRelative("PlacementCtrl_Pv_Arm_L", [29, 116, -34], [-90, 0, 0], [1, 1, 1])
    ...
    transformRelative("PlacementCtrl_Ribbon_Arm_L", [22, 123, -6.5], [-7.1, 0, 51], [6, 6, 6])
    ...
    transformRelative("PlacementCtrl_Ribbon_Elbow_L", [40, 106, -6.5], [6, 0, 51], [5, 5, 5])
    ...
    transformRelative("PlacementCtrl_Pin_Elbow_L", [30, 116, -8.4], [0, 0, 51], [5.2, 5.2, 5.2])
