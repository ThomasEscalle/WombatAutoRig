...
Ankle_L = createController(pos=(4.125,9.609,-0.318),name='Ankle_L')
#Ankle_R = createController(pos=(-4.125,9.609,-0.318),name='Ankle_R')  On les fera symetrique nos modeles de toutes façon
Ball_L = createController(pos=(4.366,2.707,4.391),name='Ball_L')
#Ball_R = createController(pos=(-4.366,2.707,4.391),name='Ball_R')
Toe_L = createController(pos=(4.411,1.428,8.568),name='Toe_L')
#Toe_R = createController(pos=(-4.411,1.428,8.568),name='Toe_R')
Knee_L = createController(pos=(4.299,28.693,0.09),name='Knee_L')
#Knee_R = createController(pos=(-4.299,28.693,0.09),name='Knee_R')
Leg_L = createController(pos=(4.46,46.985,0), name='Leg_L')
Root = createController(pos=(0,52,0), localRotation = [0,0,90], name='Root')
...
#RANGEMENT
cmds.parent('Ankle_L','Ball_L','Toe_L','Knee_L',Leg_L, Root, Line0, Line1, Line2, Line3, Line4, groupWIP)
